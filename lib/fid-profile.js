 ...
 */
// fid-umd {"global":1,"jslint":1,"name":"FidProfile"}
/*global define, YUI*/
(function (n, r, s) {
	"use strict";
	 ...
	 * @return number
	 */
	FidProfile.prototype.sortBySelfAverage = function (a, b) {
	 ...
	 * @return number
	 */
	FidProfile.prototype.sortBySelf = function (a, b) {
	...
	FidProfile.prototype.wrapFunction = function (original, name) {
		var myself, profile, wrapped;

		profile = this.isProfiled(original);
		...
		wrapped = function () {
			...
			function addElapsed(elapsed) {
				var myExclusions;
				myExclusions = myself.profileExclusions.pop();
				profile.calls += 1;
				...
				myself.profileExclusions.push(myself.profileExclusions.pop() + elapsed);
			}
			...
			myself.profileExclusions.push(0);
